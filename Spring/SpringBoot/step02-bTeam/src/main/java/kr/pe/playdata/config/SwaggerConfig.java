...
//spring api
import org.springframework.context.annotation.Bean; //spring bean 객체 생성
import org.springframework.context.annotation.Configuration; //spring 설정
...
public class SwaggerConfig {
    ...
    @Bean //Docket 객체를  spring 컨테이너에게 관리 위임(spring bean으로 등록)
    public Docket swaggerApi() {
    	...
    	//apis() : api 스펙이 작성되어 있는 패키지 및 서브 패키지(Controller) 를 지정하여, 애노테이션이 선언된 API를 문서화
